...
-- Zrzucanie danych dla tabeli fb-clone.friendStatus: ~2 rows (około)
...
-- Zrzucanie danych dla tabeli fb-clone.privacyLevel: ~2 rows (około)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `registerDate` int(11) NOT NULL DEFAULT current_timestamp(),
...
-- Zrzucanie danych dla tabeli fb-clone.users: ~7 rows (około)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`idUser`, `idPrivacy`, `email`, `password`, `registerDate`, `token`, `tokenValid`, `active`) VALUES
	(1, 0, 's.k@ff.com', 'Qwerty8*', 0, '0', 0, 0),
	(2, 0, 'd.vader@theempire.com', 'ZAQ!', 2147483647, '0', 0, 0),
	(11, 0, 'qwe@qwe.com', 'qwe', 2147483647, '0', 0, 0),
	(15, 0, 'qwe@qw2e.com', 'qwe', 2147483647, '0', 0, 0),
	(16, 0, 'qwe@qw3e.com', '$2y$10$QoC94ns67WNZ0AFUBXGiTO/zR5wiPxNzLzG90O.RJbSwqQlsuNcDy', 2147483647, '0', 0, 0),
	(27, 0, 'qwew33e.com', '$2y$10$BZ8wdBDS5IOhJlAqWs49XOi5d1Uu3XBHlBOhRgOMKE9H/90hNS.au', 2147483647, '0', 0, 0),
	(28, 0, 'qwe4@3e.com', '$2y$10$ZAicTBYEEBTuH5OYzgXUuOBpvhGLT8mUKOy2s2OR27mjn2G8al0Sm', 2147483647, '0', 0, 0);
